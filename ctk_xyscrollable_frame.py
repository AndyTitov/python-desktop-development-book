...
class CTkXYScrollableFrame(tkinter.Frame, CTkAppearanceModeBaseClass, CTkScalingBaseClass):
    def __init__(self,
                 master: Any,
                 width: int = 200,
                 height: int = 200,
        ...
        self._scrollbar_x = CTkScrollbar(
        ...
        self._scrollbar_y = CTkScrollbar(
            master=self._parent_frame,
    ...
    def _create_grid(self):
        ...
        if self._label_text is not None and self._label_text != "":
            ...
            canvas_pady = (border_spacing, 0)
        else:
            self._label.grid_forget()
            canvas_pady = border_spacing
    ...
    def configure(self, **kwargs):
        ...
        if "scrollbar_fg_color" in kwargs:
            color = kwargs.pop("scrollbar_fg_color")
            self._scrollbar_x.configure(fg_color=color)
            self._scrollbar_y.configure(fg_color=color)

        if "scrollbar_button_color" in kwargs:
            color = kwargs.pop("scrollbar_button_color")
            self._scrollbar_x.configure(button_color=color)
            self._scrollbar_y.configure(button_color=color)

        if "scrollbar_button_hover_color" in kwargs:
            color = kwargs.pop("scrollbar_button_hover_color")
            self._scrollbar_x.configure(button_hover_color=color)
            self._scrollbar_y.configure(button_hover_color=color)
