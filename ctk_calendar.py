...
class CTkCalendar(customtkinter.CTkFrame):
    def __init__(
        ...
        self.day_buttons: dict[int, customtkinter.CTkButton] = {}
    ...
    def _x(self, value: float) -> int:
        return int(self.width * value / 250)

    def _y(self, value: float) -> int:
        return int(self.height * value / 270)

    def _button_size(self, value: float) -> int:
        return max(18, int(min(self.width, self.height) * value / 250))
    ...
    def _create_static_widgets(self):
        ...
        self.month_and_year.place(x=self._x(125), y=self._y(15), anchor="center")

        nav_size = self._button_size(22)
        ...
        self.double_left_arrow.place(x=self._x(20), y=self._y(15), anchor="center")
        ...
        self.left_arrow.place(x=self._x(45), y=self._y(15), anchor="center")
        ...
        self.right_arrow.place(x=self._x(205), y=self._y(15), anchor="center")
        ...
        self.double_right_arrow.place(x=self._x(230), y=self._y(15), anchor="center")
        ...
        for weekday in self.weekdays:
            ...
            label.place(x=self._x(x_pos), y=self._y(42), anchor="center")
    ...
    def render_calendar(self):
        ...
        cell_width = 35
        cell_height = 34
        button_size = self._button_size(30)

        column = first_weekday
        row = 0
        ...
        for day in range(1, number_of_days + 1):
            ...
            button = customtkinter.CTkButton(
                ...
                corner_radius=6,
                command=lambda selected_day=day: self.on_day_click(selected_day),
            )
            button.place(x=self._x(x), y=self._y(y), anchor="center")
